...
struct MakeupStudioSheet: View {
    ...
    static let textures: [(String?, String)] = [
        (nil, "None"),
        ("makeup_douyin.png", "Douyin"), ("makeup_doll_pink.png", "Doll Pink"),
        ("makeup_egirl.png", "E-Girl"), ("makeup_glam_contour.png", "Glam"),
        ("makeup_coquette.png", "Coquette"), ("makeup_goth.png", "Goth"),
        ("makeup_peach.png", "Peach"), ("makeup_cold_beauty.png", "Cold"),
        ("makeup_sunset.png", "Sunset"), ("makeup_angel.png", "Angel"),
        ("makeup_baddie.png", "Baddie"), ("makeup_cyber_chrome.png", "Chrome"),
