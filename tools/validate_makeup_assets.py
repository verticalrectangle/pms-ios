...
def main():
    ...
    if len(makeup_ids) != 35:
        error(errors, f"Makeup rail has {len(makeup_ids)} presets, expected 35")
    ...
    expected_tex_count = 35 - 2  # natural and belle are procedural; the rest use a plate
